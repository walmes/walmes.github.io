...
```{r, echo = FALSE, fig.align = "center", fig.height = 4.32, fig.width = 7, dev.args = list(png = list(family = "Roboto Condensed")), fig.cap = cap}
gg1
```
...
first author. This list includes publications in journals, books and
chapters.
